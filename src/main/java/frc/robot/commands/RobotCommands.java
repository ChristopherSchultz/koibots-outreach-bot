...
public class RobotCommands {
    public static Command getKillAllHumansCommand(Subsystem drivetrain, Spindexer spindexer, Feeder feeder,
        ...
        return // drivetrain.stalk().andThen
               // .andThen(
        eyes.getAngryCommand().andThen(ShooterCommands.getStartShootingCommand(spindexer, feeder, shooter))
    ...
    public static Command getStealthModeCommand(Subsystem drivetrain, Spindexer spindexer, Feeder feeder,
        ...
        ShooterCommands.getStopShootingCommand(spindexer, feeder, shooter).andThen(eyes.getActCasualCommand());
    }
}
