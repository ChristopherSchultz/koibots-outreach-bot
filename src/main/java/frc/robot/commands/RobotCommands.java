...
public class RobotCommands {
    public static Command getKillAllHumansCommand(Subsystem drivetrain, Spindexer spindexer, Feeder feeder, Subsystem turret, Shooter shooter, Subsystem eyes) {
        return // drivetrain.stalk().andThen
            // .andThen(eyes.getAngryCommand())
            ShooterCommands.getStartShootingCommand(spindexer, feeder, shooter)
    ...
    public static Command getStealthModeCommand(Subsystem drivetrain, Spindexer spindexer, Feeder feeder,
            Subsystem turret, Shooter shooter, Subsystem eyes) {
                return
